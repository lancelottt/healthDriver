...
//体脂
import FatRate from "@/components/store/fatRate";
//体温
import AnimalHeat from "@/components/store/animalHeat";
//血糖
...
export default new Router({
    routes: [
        ...
        //体温
        {
            path: "/device/AnimalHeat",
            name: "",
            component: AnimalHeat
        },
        //血糖
        {
            path: "/device/BloodGlucose",
            name: "",
            component: BloodGlucose
        },
        //血压
        {
            path: "/device/BloodPressure",
            name: "",
        ...
        {
            path: "/device/SetWeight",
            name: "",
            component: SetWeights
        },
        //		健康数据中的血压**
        {
            path: "/pressure",
