<template xmlns:v-touch="http://www.w3.org/1999/xhtml">
  <div>
    ...
    <div class="ruler " ref="testAA" style="">
      <div class="main"
...
<style>
    ...
    .ruler li {
        ...
        /*background: url(../../../static/images/ruleBg.png) left top no-repeat;*/
    ...
    .ruler .arrow {
        ...
        width: 13px;
        height: 35px;
        background: url(../../../static/images/weightnbt.png)center no-repeat;
    ...
    .main li:first-child {
        background: url(../../../static/images/ruleBgl.png) right top no-repeat !important;
        background-size: 104px 23px !important;
    }
</style>